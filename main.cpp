...
// Function that gives the compplement of an array. This is used before the
// start of the algo loop. Second have is the same as the add function, but
// reversed because the multiplicand is reversed at the begging.
...
// Note: This is an arithmetic right shift the value of the MSB is going to be
// inputted at the end of the word.

void arithmeticRightShft(int accumulator[], int multiplier[], int &E,
...
void boothAlgorithm(int multiplicand[], int multiplier[],
                    int multiplicandComp[], int multiplierLength,
                    int multiplicandLength, int sequenceCounter, int addCount,
                    int subCount) {
  int E = 0;
  ...
  // Main Loop, based on the Sequence Counter and based off the multiplicand
  // length.
...
void modifiedBoothAlgorithm(int multiplicand[], int multiplier[],
                            int multiplicandComp[], int multiplierLength,
                            int multiplicandLength, int sequenceCounter,
                            int addCounter, int subCounter) {
...
void populateBinaryArray(int binaryNumberArray[], int size,
                         string binaryNumber) {
...
void algorithmInit(int algorithmVersion) {
  ...
  if (algorithmVersion == 0) {
    boothAlgorithm(multiplicand, multiplier, multiplicandComp, multiplierLength,
                   multiplicandLength, sequenceCounter, addCount, subCount);
  } else {
    modifiedBoothAlgorithm(multiplicand, multiplier, multiplicandComp,
                           multiplierLength, multiplicandLength,
                           sequenceCounter, addCount, subCount);
  }
